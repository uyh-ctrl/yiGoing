...
export const constantRouterMap: RouteRecordExt[] = [
  ...
  { path: '/shop', component: () => import('@/views/shop/index.vue'), hidden: true },
  {
    path: '',
    component: Layout,
    redirect: '/home',
    ...
    children: [
      ...
      },
      {
        path: 'ai-support',
        name: 'aiSupport',
        component: () => import('@/views/aiSupport/index.vue'),
        meta: { title: '智能客服中心', icon: 'cms' },
      },
      // {
      //   path: 'test',
      //   name: 'test',
...
/* 后台业务路由已迁移至 admin-routes.ts，按需由权限模块加载。 */
